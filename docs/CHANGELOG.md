...
- 保留代码标识、CLI、协议字段、任务类型、枚举与数学符号的原始名称。
- 在 `AGENTS.md` 中增加中文权威与术语一致性规则，并增加防止活动规范文档重新退化为英文主体文本的回归检查。
- 不修改 runtime、configuration、checkpoint、Stage 3C 冻结结果或 Stage 3C-38 的授权边界。
