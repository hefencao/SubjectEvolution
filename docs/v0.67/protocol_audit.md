...
Audit SHA-256: `52943817f931ac5c52f2ae260e7eaaf7692d4ac74debe48fafcfa287155dff50`
...
- audit / plan: `demographic-selection-validity-audit-v1` / `demographic-selection-validity-plan-v1`
- independent unit: `run-seed`
- windows independent: False
- default population floor: 0.25
- turnover requirements: {'minimum_mean_generation': 1.0, 'minimum_max_generation': 3, 'minimum_cumulative_births_per_initial': 1.0}
...
- boundary: rapid collapse before generation turnover is retained as a bottleneck-dominated trajectory, useful for mechanism and failure-mode analysis but not sufficient evidence of effective evolutionary selection
...
- grid: 4 × 4 (16 regions)
- physical region: 128.0 × 128.0
- world cells per region: 32.0 × 32.0
- grid-aligned: True
