...
Schema: `paired-exploration-candidate-ledger-v4`
...
A manipulation-confirmed terminal aggregate-family gate can close its mechanism family. Reopening requires a higher family revision and an explicit scientific rationale; relabeling a child candidate is insufficient.
