...
| D2-15 | active | A new compositional mechanism could remain genetically present but phenotypically unused. | Compare composition-active and coupling-neutral fresh populations with identical genes, mutation streams and coupling cost; inspect mediated signal over time. |
| D2-16 | active | Same-function hierarchy may still collapse to one dominant downstream slot. | Report mediated signal, amplification/suppression and direct contribution by hierarchy level; do not infer combination from gene variance alone. |
...
| DEV-01 | guarded | Editable installs can point to another checkout or stale console metadata. | `make conda-check` must prove direct URL, exact source root, seventeen entries and external smoke. |
