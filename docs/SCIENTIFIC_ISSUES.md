...
| D2-06 | guarded | Source audit checkpoints are lineage-dominated. | Replication in less concentrated populations or lineage-targeted evidence. |
...
| DEV-01 | guarded | Editable installs can point to another checkout or stale console metadata. | `make conda-check` must prove direct URL, exact source root, six entries and external smoke. |
