...
| spatial-processing-conversion-acute-effect-v1 | spatial-processing-support | 1 | aggregate-path-gate | open-recorded | screen |
...
- immutable baseline entries: 6
- effective merged entries: 6
