...
Audit SHA-256: `b8b7abb9e699ffb19a4915915e55425441b49620e34e37d75b40ee255c7fddf5`
...
- readiness / plan: `exploration-readiness-audit-v1` / `tiered-exploration-plan-v1`
- independent unit: `seed`
- nested observations: ['time windows', 'entities', 'births and deaths', 'moves and policy events']
- stages: {'smoke': {'minimum_seeds': 2, 'maximum_initial_entities': 512, 'maximum_ticks': 180}, 'screen': {'minimum_seeds': 8, 'maximum_initial_entities': 2048, 'maximum_ticks': 600}, 'replication': {'minimum_seeds': 8, 'maximum_initial_entities': 4096, 'maximum_ticks': 900, 'requires_disjoint_screen_seeds': True}, 'confirmation': {'minimum_seeds': 8, 'requires_disjoint_all_prior_stage_seeds': True, 'requires_explicit_large_long_authorization': True}}
