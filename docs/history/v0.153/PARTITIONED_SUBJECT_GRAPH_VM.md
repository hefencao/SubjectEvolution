# Historical v0.153 snapshot — non-normative

> This file preserves the pre-v0.154 text for audit continuity. Do not update or cite it as the current project contract.
