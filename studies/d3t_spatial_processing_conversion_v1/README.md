# D3-T spatial-processing conversion

This directory is the canonical index for the complete D3-T acute result chain.
...
remain the exact historical runbook and are not authorization to rerun the stage.
Result transport uses the dedicated import and export command files. Commands are
intentionally kept out of this README.
