...
from subject_evolution.environment_diversity import (
...
CONFIG = ROOT / "configs" / "d0_orthogonal_environment_smoke.json"
...
def test_resource_diversity_cli_and_protocol_audit(tmp_path: Path) -> None:
    ...
    assert protocol["schema"] == "structural-measurement-protocol-audit-v3"
